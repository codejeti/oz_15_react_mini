  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-4 sm:p-8 max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="bg-gray-800 p-6 rounded-xl shadow-2xl space-y-6">
        ...
        <button
          type="submit"
          className="w-full flex items-center justify-center p-3 bg-yellow-500 text-gray-900 font-bold rounded-lg shadow-md hover:bg-yellow-400 transition"
        >
          <Send size={20} className="mr-2" /> 요청 제출하기
        </button>
      </form>
    </div>
  );
